...
public final class Constants {
  ...
  public static final class driveTrainConstants {
    ...
    public static final double encoderAdjustment = 0.95; //2500 = 32in/82.5cm
    ...
    public static final double kEncoderMetersPerMotorRev = (encoderAdjustment * motorRevsToWheelRevs
    ...
    public static final double testDistance = 0.05;
