...
public final class Constants {
  public static final class robotConstants {
    ...
    public static final int SPEED_BUTTON = BUTTON6;
    public static final int SLOW_BUTTON = BUTTON4;
    public static final int SHOOT_BUTTON = BUTTON1;
    public static final int INTAKE_BUTTON = BUTTON3;
    public static final int INTAKE_MOTOR_BUTTON = BUTTON7;
